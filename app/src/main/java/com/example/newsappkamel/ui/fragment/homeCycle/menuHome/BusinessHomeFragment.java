...
public class BusinessHomeFragment extends BaseFragment {
    @BindView(R.id.business_home_fragment_rv)
    RecyclerView businessHomeFragmentRv;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_business_home, container, false);
    ...
    private void excuteConnection(NewsAdapter adapter, RecyclerView.LayoutManager layoutManager) {
        getClient().getSpecificNews(SettingsHomeFragment.CN,"business", NewsHomeCycleActivity.API_KEY).enqueue(new Callback<GeneralRequest>() {
            @Override
